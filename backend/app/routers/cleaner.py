...
from app.utils.magic import validate_image, get_mime_and_extension
from app.services.scanner import scan_metadata
from app.services.cleaner import clean_metadata
...
async def api_clean(
    ...
    try:
        ...
        async with clean_lock:
            # We add a 2.5 seconds artificial delay to make the queue processing clearly visible
            # in concurrent requests / test script, representing a heavy image cleaning workload.
